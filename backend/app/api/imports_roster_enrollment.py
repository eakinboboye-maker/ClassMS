...
def _parse_enrollment_rows(rows: list[dict]) -> tuple[list[ParsedEnrollmentRow], list[dict]]:
...
def parse_enrollment_rows(
    ...
    rows, errors = _parse_enrollment_rows(payload.rows)
